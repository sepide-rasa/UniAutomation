...
<%{
      ...
      sp_rptNoEating.Fill(dt.sp_RptNotEating, MyLib.Shamsi.Shamsi2miladiDateTime(Session["Sdate"].ToString()), MyLib.Shamsi.Shamsi2miladiDateTime(Session["Edate"].ToString()));

      WebReport1.Report.Load(AppDomain.CurrentDomain.BaseDirectory + @"\" + @"\Reports\RptNotEating.frx");
