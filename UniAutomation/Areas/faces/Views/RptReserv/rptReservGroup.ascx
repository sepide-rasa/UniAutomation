...
<%{
      ...
      sp_GroupReserv.Fill(dt.sp_RptReservsGroups, Convert.ToDateTime(Session["SrartDate"]), Convert.ToDateTime(Session["EndDate"]), Convert.ToInt32(Session["Nobat"]));

      WebReport1.Report.Load(AppDomain.CurrentDomain.BaseDirectory + @"\" + @"\Reports\RptReservGroup.frx");
