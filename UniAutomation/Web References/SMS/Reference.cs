...
namespace UniAutomation.SMS {
    ...
    public partial class Send : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback SendFastSMSOperationCompleted;
        
        private bool useDefaultCredentialsSetExplicitly;
        
        /// <remarks/>
        public Send() {
            this.Url = global::UniAutomation.Properties.Settings.Default.UniAutimation_SMS_Send;
        ...
        /// <remarks/>
        public event SendFastSMSCompletedEventHandler SendFastSMSCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/SendFastSMS", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string SendFastSMS(string username, string password, string to, string from, string text, int linkId) {
            object[] results = this.Invoke("SendFastSMS", new object[] {
                        username,
                        password,
                        to,
                        from,
        ...
        /// <remarks/>
        public void SendFastSMSAsync(string username, string password, string to, string from, string text, int linkId) {
            this.SendFastSMSAsync(username, password, to, from, text, linkId, null);
        }
        
        /// <remarks/>
        public void SendFastSMSAsync(string username, string password, string to, string from, string text, int linkId, object userState) {
            if ((this.SendFastSMSOperationCompleted == null)) {
                this.SendFastSMSOperationCompleted = new System.Threading.SendOrPostCallback(this.OnSendFastSMSOperationCompleted);
            }
            this.InvokeAsync("SendFastSMS", new object[] {
                        username,
                        password,
                        to,
                        from,
                        text,
                        linkId}, this.SendFastSMSOperationCompleted, userState);
        }
        
        private void OnSendFastSMSOperationCompleted(object arg) {
            if ((this.SendFastSMSCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.SendFastSMSCompleted(this, new SendFastSMSCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9037.0")]
    public delegate void SendFastSMSCompletedEventHandler(object sender, SendFastSMSCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.9037.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class SendFastSMSCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal SendFastSMSCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
